...
async function findAgentUrl(agentName) {
  try {
    ...
    const rootUrl = `https://raw.githubusercontent.com/dhorvathdh/claude-code-templates/main/cli-tool/components/agents/${agentName}.md`;
    ...
    const categoriesResponse = await fetch('https://api.github.com/repos/dhorvathdh/claude-code-templates/contents/cli-tool/components/agents');
    ...
    for (const item of contents) {
      if (item.type === 'dir') {
        const categoryUrl = `https://raw.githubusercontent.com/dhorvathdh/claude-code-templates/main/cli-tool/components/agents/${item.name}/${agentName}.md`;
        try {
