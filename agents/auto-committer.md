...
4. **Commit message generation**: Create conventional commit messages using this format: `<type>: <description>`
   - Types: feat, fix, docs, style, refactor, perf, test, chore
   - Use present tense, imperative mood
   - Keep first line under 72 characters
   - Be specific but concise

5. **Multi-commit assessment**: If changes span multiple unrelated areas, suggest splitting into separate commits rather than creating one large commit.
